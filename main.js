...
function main() {
    ...
    const sirip = new Fin(GL, LIBS, SHADER_PROGRAM, locations, {
        color: [60/255, 68/255, 82/255, 1.0],
        shininess: 5.0,
        y: 0.6, // Posisikan di atas kepala
        rx: LIBS.degToRad(15) // Miringkan sedikit ke belakang
    });

    // Sirip-sirip kecil di depan (bagian abu-abu segmented di atas dahi)
    const siripDepan1 = new Fin(GL, LIBS, SHADER_PROGRAM, locations, {
        color: [60/255, 68/255, 82/255, 1.0],
        shininess: 5.0,
        y: 0.75, z: 0.25,
        rx: LIBS.degToRad(25),
        scaleX: 0.35, scaleY: 0.45, scaleZ: 0.8
    });
    const siripDepan2 = new Fin(GL, LIBS, SHADER_PROGRAM, locations, {
        color: [60/255, 68/255, 82/255, 1.0],
        shininess: 5.0,
        y: 0.78, z: 0.15,
        rx: LIBS.degToRad(22),
        scaleX: 0.35, scaleY: 0.5, scaleZ: 0.8
    });
    const siripDepan3 = new Fin(GL, LIBS, SHADER_PROGRAM, locations, {
        color: [60/255, 68/255, 82/255, 1.0],
        shininess: 5.0,
        y: 0.8, z: 0.05,
        rx: LIBS.degToRad(18),
        scaleX: 0.35, scaleY: 0.48, scaleZ: 0.8
    });
    ...
    kepalaAtas.childs.push(sirip);
    kepalaAtas.childs.push(siripDepan1);
    kepalaAtas.childs.push(siripDepan2);
    kepalaAtas.childs.push(siripDepan3);
